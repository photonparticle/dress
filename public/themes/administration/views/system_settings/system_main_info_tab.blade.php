...
<div class="tab-pane active" id="main_info">
    ...
    <div class="form-group form-md-line-input has-info form-md-floating-label">
        <label for="work_time" class="control-label col-xs-12 default no-padding">
            {{trans('system_settings.work_time')}}
        </label>
        <div class="col-xs-12 no-padding">
            <div id="work_time">
                {!!isset($system_settings['work_time']) ? $system_settings['work_time'] : ''!!}
            </div>
        </div>
