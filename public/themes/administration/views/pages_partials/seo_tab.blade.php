    ...
    <form action="#">
        ...
        <div class="form-group form-md-line-input has-success form-md-floating-label">
            <div class="input-icon right">
                ...
                <label for="friendly_url">{{trans('pages.friendly_url')}}</label>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 no-padding">
                <textarea id="meta_description"
                          class="form-control"
                          rows="3" 
                          placeholder="{{trans('pages.meta_description')}}"
        ...
        <div class="form-group">
            <label for="meta_keywords" class="control-label col-xs-12 default no-padding">
                {{trans('pages.meta_keywords')}}
            </label>
            <div class="col-xs-12 no-padding">
                <textarea id="meta_keywords"
                          class="form-control"
                          rows="3" 
                          placeholder="{{trans('pages.meta_keywords')}}"
