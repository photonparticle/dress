            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body">
                    <div id="site_statistics_loading">
                        <img src="/themes/administration/assets/admin/layout2/img/loading.gif" alt="loading"/>
                    </div>
                            ...
                            <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                                <div class="row">
                                    <div class="col-md-6 user-info">
                                        <img alt="" src="/themes/administration/assets/admin/layout2/img/avatar.png" class="img-responsive"/>
                                        <div class="details">
                                            <div>
                                                <a href="javascript:;">
                                                    Robert Nilson </a>
            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body" id="chats">
                    <div class="scroller" style="height: 353px;" data-always-visible="1" data-rail-visible1="1">
                        <ul class="chats">
                            <li class="in">
                                <img class="avatar" alt="" src="/themes/administration/assets/admin/layout2/img/avatar1.jpg"/>
                                <div class="message">
												<span class="arrow">
												</span>
                            ...
                            <li class="out">
                                <img class="avatar" alt="" src="/themes/administration/assets/admin/layout2/img/avatar2.jpg"/>
                                <div class="message">
												<span class="arrow">
												</span>
                                    <a href="javascript:;" class="name">
                            ...
                            <li class="out">
                                <img class="avatar" alt="" src="/themes/administration/assets/admin/layout2/img/avatar3.jpg"/>
                                <div class="message">
												<span class="arrow">
												</span>
                                    <a href="javascript:;" class="name">
