        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class=" mid-pop">
                <div class="pro-img">
                    ...
                    <div class="zoom-icon ">
                        <a class="quick_buy_trigger" href="/{{$products[$product_id]['slug']}}">
                    ...
                    <div class="mid-2">
                        <p>
                            ...
                            !empty($products[$product_id]['active_discount']))
                                <em class="item_old_price">{{$products[$product_id]['price']}} {{trans('client.currency')}}</em>
                                <em class="item_price">{{$products[$product_id]['discount']}} {{trans('client.currency')}}</em>
                            @else
                        ...
                        <div class="img item_add">
                            <a class="quick_buy quick_buy_trigger" href="/{{$products[$product_id]['slug']}}" title="{{trans('client.quick_buy_tip')}}" data-toggle="tooltip" data-placement="top">
