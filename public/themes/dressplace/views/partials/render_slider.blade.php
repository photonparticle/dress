                ...
                <ul>
                    @foreach($slider['slides_positions'] as $image => $position)
                        ...
                        @if(!empty($slider['slides'][$image]['title']))
                            ...
                            <?php
                            //Slider offsets
                            if ( ! empty($slider['slides'][$image]['place']) && in_array($slider['slides'][$image]['place'], ['left', 'center', 'right']))
                            {
                                if ($slider['slides'][$image]['place'] == 'left')
                                {
                                    $offset = 20;
                                }
                                elseif ($slider['slides'][$image]['place'] == 'right')
                                {
                                    $offset = -20;
                                }
                                else
                            ...
                            <!-- Slide Caption -->
                                <div class="tp-caption skewfromrightshort skewtorightshort tp-resizeme"
                                     data-x="{{$pos}}" data-hoffset="{{$offset}}"
